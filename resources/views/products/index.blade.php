...
@csrf
  <div class="c-search-tab__main-container">
        ...
        <div class="c-search-tab__item">
          <div class="c-search-tab__warning">都道府県</div>
        ...
        <div class="c-search-tab__item">
          <div class="c-search-tab__warning">カテゴリー</div>
        ...
        <div class="c-search-tab__item-for-price">
          <div class="c-search-tab__warning-for-price">値段</div>
      ...
      <div class="c-search-tab__item-for-checkbox">
        <div class="c-search-tab__warning-for-price">賞味期限切れ</div>
        ...
        <div class="c-search-tab__warning-for-price">在庫なし</div>
        <div class="c-search-tab__checkbox">
...
<div class="c-product-list__container">
  ...
  <div class="c-product-list__head-info">検索結果{{ $productList->total() }}件のうち {{ $productList->firstItem() }}-{{ $productList->lastItem() }}件</div>
  ...
  <a href="{{ route('products.show', $product->product_id )}}" class="c-product-list__box">
    ...
    <div class="c-product-list__body">
      ...
      <div class="c-product-list__name">{{ $product->product_name }}</div>
      <div class="c-procut-list__store">{{ $product->company_name }}</div>
      <div class="c-procut-list__address">{{ $product->prefecture_name }}{{ $product->store }}</div>
    </div>
    @if ($product->sold_flg == 0)
    <div class="c-product-list__sold-out c-product-list__sold-out--normal"><i class="far fa-circle"></i></div>
    @elseif ($product->sold_flg == 1 && $product->user_id == Auth::id() )
    <div class="c-product-list__sold-out c-product-list__sold-out--check-and-purchase">購入<i class="fas fa-check"></i></div>
    @elseif ($product->sold_flg == 1)
    <div class="c-product-list__sold-out c-product-list__sold-out--check"><i class="fas fa-times"></i></div>
    @endif
