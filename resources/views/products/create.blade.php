...
@csrf
  <div class="c-product__container">
    ...
    <div class="c-product__item">
      ...
      <input class="c-product__input--small" type="text" name="price" value="{{ old('price')}}" placeholder="例)150"/><span class="c-product__letter-for-yen">円</span>
    </div>
    @error('price')
        <span class="c-auth--error">
            <strong>{{ $message }}</strong>
    ...
    <div class="c-product__item">
      ...
      <input class="c-product__input-for-expiration" type="text" name="hour" value="{{ old('hour')}}" placeholder="例)21"/><div class="c-product__letter">時</div>
    </div>
    @error('hour')
        <span class="c-auth--error">
            <strong>{{ $message }}</strong>
