...
class CompanyPasswordResetNotification extends ResetPassword
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->action(Lang::getFromJson('Reset Password'), url(config('app.url').route('company_auth.password.reset', ['token' => $this->token, 'email' => $notifiable->getEmailForPasswordReset()], false)))
